...
public class Aplicacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textoAltura.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                textoAlturaKeyTyped(evt);
            }
        });
    ...
    private void textoPesoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textoPesoKeyTyped
      char n=evt.getKeyChar();//char= carateres.
    ...
    private void textoAlturaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textoAlturaKeyTyped
     char n=evt.getKeyChar();
      
        if (n< '0'|| n>'9')evt.consume(); { // se llama pipe ||
            
        }
    }//GEN-LAST:event_textoAlturaKeyTyped
